...
enum ExpanduinoCommandMeta {
  ...
  EXPANDUINO_CMD_META_SET_INTERRUPTION_ENABLED = 6,
  EXPANDUINO_CMD_META_NUM_SUBDEVICES           = 7,
  EXPANDUINO_CMD_META_SUBDEVICE_TYPE           = 8,
  EXPANDUINO_CMD_META_SUBDEVICE_NAME           = 9,
  EXPANDUINO_CMD_META_SUBDEVICE_SHORT_NAME     = 10
};
